...
def main():
    ...
    maxEpochs = 50
    learnRate = 0.6
    print("\nМаксимальное число эпох = " + str(maxEpochs))
    print("Скорость обучения = %0.3f " % learnRate)
    print("\nНачало обучения")
    ...
    print("\nТочность по данным из обучающей выборки = %0.4f " % accTrain)
    print("Точность по данным из тестовой выборки   = %0.4f " % accTest)
